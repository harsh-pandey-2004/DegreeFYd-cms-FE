...
const Dashboard = ({ setId }) => {
  ...
  const handleDelete = async (collegeData) => {
    ...
    try {
      const response = await axios.delete(
        `${BASE_URL}/courses1/${collegeData._id}`
      );
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await axios.put(
        `${BASE_URL}/courses1/approve/${selectedCollege._id}`,
        {
          userId: userId,
          status: "rejected",
        ...
        {showReasonPopup && (
          <div className="fixed inset-0 bg-transparent bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 overflow-hidden">
              <div className="flex justify-between items-center px-6 py-4 bg-[#155DFC] text-white">
                ...
                <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="pl-10 pr-4 py-2 border border-gray-300 rounded-md w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-[#155DFC] transition-colors"
                    />
                    <Search
                      size={18}
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="px-4 py-2 border border-gray-300 rounded-md flex items-center space-x-2 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-[#155DFC]"
                    >
                      <Filter size={16} />
                      <span>Filters</span>
                      {showFilters ? (
                        ...
                        <div className="space-y-2">
                          <label className="flex items-center space-x-2 cursor-pointer">
                            <input
                              ...
                              className="form-radio text-[#155DFC]"
                            />
                            <span>All</span>
                          </label>
                          <label className="flex items-center space-x-2 cursor-pointer">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="pl-3 pr-8 py-2 border border-gray-300 rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-[#155DFC]"
                    >
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-blue-50 text-[#155DFC] rounded-md hover:bg-blue-100 transition-colors focus:outline-none focus:ring-2 focus:ring-[#155DFC]"
                  >
                    Refresh
                  </button>
                </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-gray-500">
                          {courses.rejectionReason ? (
                            <button
                              ...
                              className="text-[#155DFC] hover:text-[#155DFC] hover:underline focus:outline-none"
                            >
                              View Reason
                            </button>
                          ) : (
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <div className="flex space-x-2">
                            ...
                            <button
                              className="p-1.5 text-[#155DFC] hover:text-blue-900 hover:bg-blue-50 rounded-full transition-colors tooltip shadow-sm border border-gray-100"
                              title="Edit"
                              onClick={() => {
                                setopenEdit(true);
                            ...
                            {canApprove && courses.status === "pending" && (
                              <button
                                className="p-1.5 text-[#155DFC] hover:text-green-900 hover:bg-green-50 rounded-full transition-colors tooltip shadow-sm border border-gray-100"
                                title="Approve"
