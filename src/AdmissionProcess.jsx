    ...
    <div className="bg-white p-6 rounded-lg shadow-md" id="admission-process">
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center">
          <h3 className="font-medium text-lg mb-2 text-blue-700">Admission Steps</h3>
          <button
            type="button"
      ...
      {formData.admissionProcess.steps.map((step, index) => (
        <div key={index} className="mb-4 p-4 border rounded-lg bg-gray-50 hover:shadow-md transition-shadow">
          ...
          <div className="relative">
            <span className="absolute top-3 left-3 flex items-center justify-center h-5 w-5 bg-blue-600 text-white rounded-full text-xs">
              {index + 1}
            </span>
            <input
              type="text"
              ...
              className="w-full p-2 pl-10 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none"
